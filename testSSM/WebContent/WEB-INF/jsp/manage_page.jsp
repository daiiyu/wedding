...
<body >
	...
	<!-- above is menubar -->
<h1 align="left">重邮婚庆后台管理</h1><br>
<h5 style="marign-left:50px;">${requestScope.manage.getM_name()}&nbsp;管理员,欢迎您!</h5>
<ul>
<li><a href="user_manage_page.do">订单管理</a></li>
<li><a href="">用户管理</a></li>
<li><a href="">婚庆知识管理</a></li>
</ul>

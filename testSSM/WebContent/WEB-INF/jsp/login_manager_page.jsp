...
<body>
	...
	<!-- above is menubar -->
     ...
     <form action="login_manage.do">
     <table  align="center" style="font-size:15px;">
     <tr>
        <td>管理员账号:</td><td><input type="text" name="acount"></td>
     </tr>
     <tr><td>&nbsp;</td></tr>
     <tr>
      <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码:</td><td><input type="password" name="passw"></td>
     </tr>
            <tr align="center"><td colspan="4"><input type="submit" value="登录"></td></tr>
     </table>
     </form>
